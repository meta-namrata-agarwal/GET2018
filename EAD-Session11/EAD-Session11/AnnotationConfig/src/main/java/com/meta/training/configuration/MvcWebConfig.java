package com.meta.training.configuration;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.meta.training")
...
public class MvcWebConfig implements WebMvcConfigurer {
	...
	@Bean
	  public LocalSessionFactoryBean getSessionFactory() {
	    ...
	    factoryBean.setAnnotatedClasses(Project.class,JobTitleMaster.class,Skills.class,Employee.class,Skills.class,JobDetails.class,EmployeeSkills.class);
